...
import alvaro.OnClickProductosYProveedores;
public class ventanaPrincipal extends JFrame{
    ...
    ventanaPrincipal() {
        ...
        prod1 = new JMenuItem("Gestionar Producto");
        prod1.setFont(new Font("Arial Black", Font.BOLD, 12));
        prod1.addActionListener(new OnClickProductosYProveedores(this));
        prod1.setActionCommand("GESTIONAR PRODUCTOS");
        menu4.add(prod1);
